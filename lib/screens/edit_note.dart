...
class NotesEdit extends StatefulWidget {
  int? index;
  Note? note;
  NotesEdit({this.note, this.index});
...
class _NotesEditState extends State<NotesEdit> {
  ...
  updateNote(Note note, index) async {
    await dataBox.putAt(index, note);
  }

  updateNoteA(
      int index, String newTitle, String newContent, int color, int fontwe) {
    updateNote(
      Note(
        title: newTitle,
        text: newContent,
